            ...
            {otherContribution === 0 && (
                <>
                        ...
                        <div className="flex-1 p-8">
                            ...
                            <Col className="mt-8 mb-7">
                                <Row style={{ display: 'flex', alignItems: 'center' }}>
                                    ...
                                    <Button className="rounded-md bg-thirst-blue px-10 py-1 me-3 text-white shadow-md" style={{ display: 'flex', alignItems: 'center' }}>
                                ...
                                {maxTickets && (
                                    <p className="text-sm mt-2 text-red-600" id="email-error">
                                        Limite máximo de vidas atingido
                                    </p>
                                )}
                            </Col>
                    ...
                    <div className="mt-auto mx-auto flex justify-center">
                        <Button
                            className="rounded-sm bg-thirst-blue px-20 py-2 text-sm font-semibold text-white shadow-md hover:bg-white/10 hover:text-thirst-blue ring-2 ring-thirst-blue hover:ring-thirst-blue"
