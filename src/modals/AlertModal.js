...
export default function AlertModal({setModalVisible, setOtherContribution, }) {
                                    ...
                                    <div className="mt-3 text-center sm:mt-5">
                                        ...
                                        <div className="mt-2">
                                            <p className="text-sm font-bold text-thirst-dark-grey">
                                                ULTRAPASSOU OS 250€! MAS ESPERE IRÁ EXISTIR UM MOMENTO NA GALA ONDE TAMBÉM PODERÁ FAZER DOAÇÕES.
                                            </p>
                                        </div>
                                    </div>
                                </div>
